 ...
 * ```
 */
export class OraclePool extends Caller {
	/**
	 ...
	 *
	 * @param pool - The fetched `OraclePoolObject` from Aftermath API or on-chain query.
	 ...
	 */
	constructor(
		public readonly pool: OraclePoolObject,
		config?: CallerConfig,
		private readonly Provider?: AftermathApi
	) {
		super(config, `oracle-pools/${pool.objectId}`);
		this.pool = pool;
	}
	...
	/**
	 * Returns an array of `OraclePoolCoin` objects, one for each coin in this pool,
	 * sorted lexicographically by coin type.
	 *
	 * @returns An array of `OraclePoolCoin`.
	 */
	public poolCoins = (): OraclePoolCoin[] => {
	...
	/**
	 * Returns an array of `[CoinType, OraclePoolCoin]` pairs, sorted by coin type.
	 *
	 * @returns An array of coin-type => `OraclePoolCoin` pairs.
	 */
	public poolCoinEntries = (): [CoinType, OraclePoolCoin][] => {
