...
import { Casting, type SuiObjectView } from "@sdk";
import daoCapGrpc from "@test/fixtures/objects/daoFeePoolOwnerCap.grpc.json";
import daoCapJsonRpc from "@test/fixtures/objects/daoFeePoolOwnerCap.jsonrpc.json";
import farmsAdminV1Grpc from "@test/fixtures/objects/farmsOneTimeAdminCapV1.grpc.json";
import farmsAdminV1JsonRpc from "@test/fixtures/objects/farmsOneTimeAdminCapV1.jsonrpc.json";
import farmsAdminV2Grpc from "@test/fixtures/objects/farmsOneTimeAdminCapV2.grpc.json";
import farmsAdminV2JsonRpc from "@test/fixtures/objects/farmsOneTimeAdminCapV2.jsonrpc.json";
import farmsOwnerV1Grpc from "@test/fixtures/objects/farmsOwnerCapV1.grpc.json";
import farmsOwnerV1JsonRpc from "@test/fixtures/objects/farmsOwnerCapV1.jsonrpc.json";
import farmsOwnerV2Grpc from "@test/fixtures/objects/farmsOwnerCapV2.grpc.json";
import farmsOwnerV2JsonRpc from "@test/fixtures/objects/farmsOwnerCapV2.jsonrpc.json";
import farmsPosV1Grpc from "@test/fixtures/objects/farmsStakedPositionV1.grpc.json";
import farmsPosV1JsonRpc from "@test/fixtures/objects/farmsStakedPositionV1.jsonrpc.json";
import farmsPosV2Grpc from "@test/fixtures/objects/farmsStakedPositionV2.grpc.json";
import farmsPosV2JsonRpc from "@test/fixtures/objects/farmsStakedPositionV2.jsonrpc.json";
import kioskCapGrpc from "@test/fixtures/objects/kioskOwnerCap.grpc.json";
import kioskCapJsonRpc from "@test/fixtures/objects/kioskOwnerCap.jsonrpc.json";
import nftGrpc from "@test/fixtures/objects/nftWithDisplay.grpc.json";
import nftJsonRpc from "@test/fixtures/objects/nftWithDisplay.jsonrpc.json";
import personalKioskGrpc from "@test/fixtures/objects/personalKioskCap.grpc.json";
import personalKioskJsonRpc from "@test/fixtures/objects/personalKioskCap.jsonrpc.json";
import poolGrpc from "@test/fixtures/objects/pool.grpc.json";
import poolJsonRpc from "@test/fixtures/objects/pool.jsonrpc.json";
import vaultStateGrpc from "@test/fixtures/objects/stakedSuiVaultState.grpc.json";
import vaultStateJsonRpc from "@test/fixtures/objects/stakedSuiVaultState.jsonrpc.json";
import validatorCapGrpc from "@test/fixtures/objects/validatorOperationCap.grpc.json";
import validatorCapJsonRpc from "@test/fixtures/objects/validatorOperationCap.jsonrpc.json";
...
describe("PoolsApiCasting.poolObjectFromSuiObject", () => {
	it("casts the gRPC json view", () => {
		expect(Casting.pools.poolObjectFromSuiObject(grpcView(poolGrpc))).toEqual(
			expectedPool
		);
	});
	...
	it("reads `lp_supply` out of its struct envelope without losing precision", () => {
		...
		expect(Object.values(pool.coins).map((c) => c.normalizedBalance)).toEqual([
...
describe("fixtures exhibit the shape differences the port must absorb", () => {
	...
	it("the object type is identical across protocols", () => {
		expect(poolGrpc.type).toBe((poolJsonRpc as Record<string, any>).data.type);
 ...
 */
const agreeingCasters: [
	string,
	unknown,
	unknown,
	(v: SuiObjectView) => unknown,
][] = [
	[
	...
	["nfts.nftFromSuiObject", nftGrpc, nftJsonRpc, Casting.nfts.nftFromSuiObject],
];
...
describe("farms V2 one-time admin cap", () => {
	it("unwraps the nested `cap` struct to read `for`", () => {
		...
		expect(
			(farmsAdminV2JsonRpc as Record<string, any>).data.content.fields.cap
				.fields.for
		).toBe(
			"0xea8c7ef2269f99b35b7b6ae47dadc428fad9198fdf3efa442547be2a619a7c1e"
		);
