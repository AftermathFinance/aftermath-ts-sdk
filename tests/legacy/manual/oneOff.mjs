...
const indexOut =
	"0xa8ea7b79c307136b0159502ae4c188660707d2a6d4345a04ae03a8093aa49928::usdc::USDC";
const amountIn = 1789795866998400n;
const expectedOut = 16369483755n;
const actualOut = CmmmCalculations.calcOutGivenIn(
	pool,
	indexIn,
	indexOut,
	amountIn
...
function checkVsSpotPrice(pool, indexIn, indexOut) {
	const coinOut = pool.coins[indexOut];
	const spotPrice = BigInt(
		Math.floor(
			10 ** 18 * CmmmCalculations.calcSpotPriceWithFees(pool, indexIn, indexOut)
		)
	);
	...
	console.log(
		shortName(indexIn) + " " + shortName(indexOut) + ": " + amountOut
	);
